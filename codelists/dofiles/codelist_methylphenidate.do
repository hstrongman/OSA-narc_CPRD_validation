...
/*******************************************************************************
* Stata script:    codelist_methylphenidate.do
*
...
* Description: 	Run dyndoc formatted scripts to create the following HTML docs:
				(1) codelist_methylphenidate.html (describes the
				code lists).
				(2) codelist_methylphenidate_* where * = aurum and gold
...
set more off
cap log close
log using "$logdir\codelist_methylphenidate_log.txt", replace text
